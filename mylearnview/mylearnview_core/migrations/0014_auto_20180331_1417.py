...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('mylearnview_core', '0013_auto_20180305_1135'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='module',
            name='course',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='modules', to='mylearnview_core.Course', verbose_name='Course'),
        ),
        migrations.AlterField(
            model_name='module',
            name='sort_index',
